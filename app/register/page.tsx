...
export default function Register() {
  ...
  // Ajuste de colores: Volvemos al gris para iconos y placeholders para que resalten como en el login
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50/30 p-6 py-12 font-sans">
      ...
      <div className="w-full max-w-md bg-white p-10 rounded-[2.5rem] shadow-[0_20px_70px_-10px_rgba(106,95,255,0.15)] border border-purple-100">
        <div className="text-center mb-10">
          <h2 className="text-4xl font-extrabold text-[#1E1B4B] tracking-tight">Crea tu cuenta 🎈</h2>
          <p className="text-gray-500 mt-2 font-medium">Únete a la comunidad de Globos</p>
        </div>
        ...
        <form className="space-y-1">
          ...
          <div className={inputContainerStyle}>
            ...
            <input type="tel" placeholder="Teléfono" className={fieldStyle} />
          </div>
          ...
          <button 
            type="submit" 
            className="w-full bg-[#462ff7] text-white py-5 mt-6 rounded-[1.2rem] font-bold text-xl hover:bg-[#000000] active:scale-[0.98] transition-all shadow-xl shadow-[#6A5FFF]/30"
          >
            Registrarme
          </button>
        </form>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 font-medium">
            ¿Ya tienes cuenta? <Link href="/login" className="text-[#462ff7] font-bold hover:underline">Inicia sesión</Link>
          </p>
        </div>
      </div>
    </div>
